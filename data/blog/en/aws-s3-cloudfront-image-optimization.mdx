...
featured: true
banner: '/static/images/posts/aws-s3-cloudfront-image-optimization/banner-aws-s3-cloudfront-image-optimization-03.png'
images: ['/static/images/posts/aws-s3-cloudfront-image-optimization/aws-s3-cloudfront-image-optimization.png']
---

<FancyBoxImage 
  src="/static/images/posts/aws-s3-cloudfront-image-optimization/aws-s3-cloudfront-image-optimization.png" 
  alt="Banner" 
  width={2912}
  height={1632}    
  priority
...
<FancyBoxImage src="/static/images/posts/aws-s3-cloudfront-image-optimization/aws-s3-cloudfront-image-optimization.drawio.png" alt="S3, CloudFront, Lambda diagram" width={824} height={793}/>
---
...
<FancyBoxImage 
  src="/static/images/posts/aws-s3-cloudfront-image-optimization/chat-pc.png?format=webp" 
