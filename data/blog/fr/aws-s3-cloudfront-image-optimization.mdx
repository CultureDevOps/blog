...
<FancyBoxImage src="https://d2mezi5ylxaxvl.cloudfront.net/blog/aws-s3-cloudfront-image-optimization/aws-s3-cloudfront-image-optimization.drawio.png?format=auto" alt="Diagramme AWS S3, Cloudfront, Lambda" />
---
...
<FancyBoxImage 
  src="https://d2mezi5ylxaxvl.cloudfront.net/blog/aws-s3-cloudfront-image-optimization/aws-s3-cloudfront-image-optimization.drawio.png?format=auto" 
  alt="Optimisation des images avec AWS" 
/>