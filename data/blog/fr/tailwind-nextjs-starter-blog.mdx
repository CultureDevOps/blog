...
authors: ['default']
draft: false
summary: Un template de blog ultra léger
featured: true
---
...
![Rapport Lighthouse](https://d2mezi5ylxaxvl.cloudfront.net/blog/tailwind-nextjs-starter-blog/performances-culturedevops.png?format=auto)
