...
featured: true
banner: 'https://d2mezi5ylxaxvl.cloudfront.net/blog/simple-azp-agent-dind/simple-azp-agent-dind.png?format=auto'
---
...
<FancyBoxImage 
  src="https://d2mezi5ylxaxvl.cloudfront.net/blog/simple-azp-agent-dind/AZP+Agent-fr.drawio.png?format=auto" 
  alt="Pipeline Azure" 
/>
...
<FancyBoxImage 
  src="https://d2mezi5ylxaxvl.cloudfront.net/blog/simple-azp-agent-dind/azure-agent.png?format=auto" 
  alt="Azure Agent" 
/>
...
<FancyBoxImage 
  src="https://d2mezi5ylxaxvl.cloudfront.net/blog/simple-azp-agent-dind/build_success.png?format=auto" 
  alt="Build Success" 
/>