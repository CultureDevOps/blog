...
export default async function PostLayout({
  ...
  return (
    <>
      ...
      <div
        className="mb-6 bg-gradient-to-tr from-white/40 via-primary-200/30 to-white/30 dark:bg-gradient-to-tr
          dark:from-gray-900/30 dark:via-primary-950/30 dark:to-gray-900/30 backdrop-blur-sm rounded-lg p-8
          border border-white/20 dark:border-gray-700/20 h-fit shadow-xl shadow-gray-400 dark:shadow-gray-950"
      >
        <FancyboxWrapper>
          <article>
                          ...
                          {author.avatar && (
                            <Link href={`/${locale}/about/${author.slug}`}>
                              <Image
                                ...
                                alt="avatar"
                                title="avatar"
                                className="size-16 rounded-full lg:h-30 lg:w-30"
                                sizes="(max-width: 640px) 64px, 120px"
                              />
                            </Link>
                          )}
                          <dl
                            className="whitespace-nowrap text-sm font-medium leading-5 font-headings text-shadow text-shadow-gray-400/80
