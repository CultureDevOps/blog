    ...
    <>
      <div>
        <div className="flex space-x-6 lg:space-x-8">
          <div
            className="hidden h-full max-h-screen min-w-[280px] max-w-[280px] flex-wrap overflow-auto rounded-2xl pt-5
              sm:flex backdrop-blur-sm border border-white/20 dark:border-gray-700/20 bg-gradient-to-tr
              from-white/40 via-primary-200/30 to-white/30 dark:bg-gradient-to-tr dark:from-gray-900/30
              dark:via-primary-950/30 dark:to-gray-900/30 shadow-xl shadow-gray-400 dark:shadow-gray-950"
            ...
            <div className="px-6 py-4">
              <button
                ...
                className={`${
                  ...
                  } font-bold uppercase transition-colors duration-300 font-headings antialiased text-shadow
                ...
                {displayPosts.map((post) => {
                  ...
                  if (language === locale) {
                    return (
                      <li
                        key={slug}
                        className="backdrop-blur-sm bg-gradient-to-tr from-white/40 via-primary-200/30 to-white/30
                          dark:bg-gradient-to-tr dark:from-gray-900/30 dark:via-primary-950/30 dark:to-gray-900/30"
                      >
                        <div
                          className="p-5 mb-6 rounded-2xl w-full shadow-xl shadow-gray-400 dark:shadow-gray-950 border border-white/20
                            dark:border-gray-700/20 hover:bg-gradient-to-tr hover:from-white/20 hover:via-primary-300/30
                            hover:to-white/20 dark:hover:bg-gradient-to-tr dark:hover:from-gray-900/20
                            dark:hover:via-primary-900/30 dark:hover:via-primary-800/30 dark:hover:to-gray-800/20 hover:border
                            hover:border-white/20 dark:hover:border-gray-600/40 group hover:shadow-xl hover:shadow-gray-400
                        ...
                        >
                          <article className="flex flex-col space-y-2 xl:space-y-0">
                            ...
                            >
                              {post.banner && (
                                <div className="relative w-full h-auto overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
                              ...
                              <div className="space-y-3">
                                <h2
                                  className="text-2xl font-bold leading-8 tracking-tight font-headings antialiased text-gray-900
                                    dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-primary-400 text-shadow
                                    text-shadow-gray-400/80 dark:text-shadow-black"
                                >
                                  {title}
                                </h2>
