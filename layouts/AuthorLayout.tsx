      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        <div className="space-y-2 pb-8 pt-6 md:space-y-5">
          <h1
            className="text-3xl font-extrabold leading-9 tracking-tight text-heading-700 dark:text-white sm:text-4xl
              sm:leading-10 md:text-6xl md:leading-14 font-headings antialiased text-shadow
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          <div className="flex flex-col items-center space-x-2 pt-8">
            ...
            <h2
              className="pb-2 pt-4 text-2xl font-bold leading-8 tracking-tight font-headings text-shadow
                text-shadow-gray-400/80 dark:text-shadow-black"
            >
              {name}
            </h2>
